...
function FloatingConnectionLine({ fromX, fromY, toX, toY, fromPosition, toPosition, fromNode } : ConnectionLineComponentProps) {
  if (!fromNode) {
    return null;
  }
  ...
  const targetNode = {
    ...
    width: 1, height: 1, position: { x: toX, y: toY },
    data: null
  } as any;
